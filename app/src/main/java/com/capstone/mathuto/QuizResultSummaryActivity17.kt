...
import com.capstone.mathuto.databinding.ActivityQuizResultSummary17Binding
...
class QuizResultSummaryActivity17 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResultSummary17Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizResultSummary17Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = bundle!!.getIntegerArrayList(QuestionSeventeen.SELECTED_ANSWERS)
