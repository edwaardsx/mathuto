...
import com.capstone.mathuto.Main.Companion.WATCHED_TUTORIAL18
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityLessonEighteenBinding
...
import com.capstone.mathuto.timer.QuizTimer18
import com.capstone.mathuto.watch.ModuleEighteen
import com.capstone.mathuto.watch.ModuleEleven
import java.util.*

class Lesson18 : AppCompatActivity(), TextToSpeech.OnInitListener {

    private lateinit var binding: ActivityLessonEighteenBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLessonEighteenBinding.inflate(layoutInflater)
        ...
        binding.btnWatchTutorial.setOnClickListener {
            val intent = Intent(applicationContext, ModuleEighteen::class.java)
            WATCHED_TUTORIAL18 = true
        ...
        binding.btnStartQuiz.setOnClickListener {
            val intent = Intent(applicationContext, com.capstone.mathuto.timer.QuizTimer18::class.java)
            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK
            applicationContext.startActivity(intent)
            overridePendingTransition(0, 0)
        }
    ...
    private fun showObjectivesDialog() {
        ...
        dialog.setContentView(R.layout.activity_objectives_eighteen)
