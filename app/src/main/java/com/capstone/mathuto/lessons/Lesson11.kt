...
import com.capstone.mathuto.Main.Companion.WATCHED_TUTORIAL11
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityLessonElevenBinding
...
import com.capstone.mathuto.timer.QuizTimer11
import com.capstone.mathuto.watch.ModuleEleven
import com.capstone.mathuto.watch.ModuleTen
import java.util.*

class Lesson11 : AppCompatActivity(), TextToSpeech.OnInitListener {

    private lateinit var binding: ActivityLessonElevenBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLessonElevenBinding.inflate(layoutInflater)
        ...
        binding.btnWatchTutorial.setOnClickListener {
            val intent = Intent(applicationContext, ModuleEleven::class.java)
            WATCHED_TUTORIAL11 = true
        ...
        binding.btnStartQuiz.setOnClickListener {
            val intent = Intent(applicationContext, com.capstone.mathuto.timer.QuizTimer11::class.java)
            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK
            applicationContext.startActivity(intent)
            overridePendingTransition(0, 0)
        }
        ...
        binding.btnTts2.setOnClickListener {
            ...
            val lessonDescriptions = "$text2 $text3 $text4 $text5 $text6 $text7"
            if (lessonDescriptions.isNotEmpty()) {
                if (isReadingAloud) {
                    tts.stop()
                    isReadingAloud = false
    ...
    private fun showObjectivesDialog() {
        ...
        dialog.setContentView(R.layout.activity_objectives_eleven)
