...
import com.capstone.mathuto.Main.Companion.WATCHED_TUTORIAL17
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityLessonSeventeenBinding
...
import com.capstone.mathuto.timer.QuizTimer17
import com.capstone.mathuto.watch.ModuleEleven
import com.capstone.mathuto.watch.ModuleSeventeen
import java.util.*

class Lesson17 : AppCompatActivity(), TextToSpeech.OnInitListener {

    private lateinit var binding: ActivityLessonSeventeenBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLessonSeventeenBinding.inflate(layoutInflater)
        ...
        binding.btnWatchTutorial.setOnClickListener {
            val intent = Intent(applicationContext, ModuleSeventeen::class.java)
            WATCHED_TUTORIAL17 = true
        ...
        binding.btnStartQuiz.setOnClickListener {
            val intent = Intent(applicationContext, com.capstone.mathuto.timer.QuizTimer17::class.java)
            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK
            applicationContext.startActivity(intent)
            overridePendingTransition(0, 0)
        }
        ...
        binding.btnTts3.setOnClickListener {
            ...
            val lessonDescriptions = "$text5 $text6 $text7 $text8 $text9 $text10"
            if (lessonDescriptions.isNotEmpty()) {
                if (isReadingAloud) {
                    tts.stop()
                    isReadingAloud = false
    ...
    private fun showObjectivesDialog() {
        ...
        dialog.setContentView(R.layout.activity_objectives_seventeen)
