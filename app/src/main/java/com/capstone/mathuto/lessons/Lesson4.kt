...
import com.capstone.mathuto.Main.Companion.WATCHED_TUTORIAL4
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityLessonFourBinding
...
import com.capstone.mathuto.timer.QuizTimer4
import com.capstone.mathuto.watch.ModuleFour
import java.util.*

class Lesson4 : AppCompatActivity(), TextToSpeech.OnInitListener {

    private lateinit var binding: ActivityLessonFourBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnWatchTutorial.setOnClickListener {
            val intent = Intent(applicationContext, ModuleFour::class.java)
            WATCHED_TUTORIAL4 = true
        ...
        binding.btnStartQuiz.setOnClickListener {
            val intent = Intent(applicationContext, com.capstone.mathuto.timer.QuizTimer4::class.java)
            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK
            applicationContext.startActivity(intent)
            overridePendingTransition(0, 0)
        }
        binding.btnTts.setOnClickListener {
            ...
            val lessonDescriptions = "$text $text2 $text3 $text4"
    ...
    private fun showObjectivesDialog() {
        ...
        dialog.setContentView(R.layout.activity_objectives_four)
