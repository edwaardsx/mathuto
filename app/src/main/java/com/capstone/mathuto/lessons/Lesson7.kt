...
import com.capstone.mathuto.Main.Companion.WATCHED_TUTORIAL7
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityLessonSevenBinding
...
import com.capstone.mathuto.timer.QuizTimer7
import com.capstone.mathuto.watch.ModuleSeven
import java.util.*

class Lesson7 : AppCompatActivity(), TextToSpeech.OnInitListener {

    private lateinit var binding: ActivityLessonSevenBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLessonSevenBinding.inflate(layoutInflater)
        ...
        binding.btnWatchTutorial.setOnClickListener {
            val intent = Intent(applicationContext, ModuleSeven::class.java)
            WATCHED_TUTORIAL7 = true
        ...
        binding.btnStartQuiz.setOnClickListener {
            val intent = Intent(applicationContext, com.capstone.mathuto.timer.QuizTimer7::class.java)
            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK
            applicationContext.startActivity(intent)
            overridePendingTransition(0, 0)
        }
    ...
    private fun showObjectivesDialog() {
        ...
        dialog.setContentView(R.layout.activity_objectives_seven)
