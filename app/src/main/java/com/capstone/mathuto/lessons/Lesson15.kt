...
import com.capstone.mathuto.databinding.ActivityLessonFifteenBinding
...
import com.capstone.mathuto.timer.QuizTimer15
import com.capstone.mathuto.watch.ModuleEleven
import com.capstone.mathuto.watch.ModuleFifteen
import java.util.*

class Lesson15 : AppCompatActivity(), TextToSpeech.OnInitListener {

    private lateinit var binding: ActivityLessonFifteenBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLessonFifteenBinding.inflate(layoutInflater)
        ...
        binding.btnWatchTutorial.setOnClickListener {
            val intent = Intent(applicationContext, ModuleFifteen::class.java)
            WATCHED_TUTORIAL15 = true
    ...
    private fun showObjectivesDialog() {
        ...
        dialog.setContentView(R.layout.activity_objectives_fifteen)
