...
import com.capstone.mathuto.databinding.ActivityQuizResultSummary19Binding
...
class QuizResultSummaryActivity19 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResultSummary19Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizResultSummary19Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = bundle!!.getIntegerArrayList(QuestionNineteen.SELECTED_ANSWERS)
