...
import com.capstone.mathuto.databinding.ActivityQuizResultSummary11Binding
...
class QuizResultSummaryActivity11 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResultSummary11Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizResultSummary11Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = bundle!!.getIntegerArrayList(QuestionEleven.SELECTED_ANSWERS)
