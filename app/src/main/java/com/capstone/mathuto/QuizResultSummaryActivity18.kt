...
import com.capstone.mathuto.databinding.ActivityQuizResultSummary18Binding
...
class QuizResultSummaryActivity18 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResultSummary18Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizResultSummary18Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = bundle!!.getIntegerArrayList(QuestionEighteen.SELECTED_ANSWERS)
