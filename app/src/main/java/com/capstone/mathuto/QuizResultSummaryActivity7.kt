...
import com.capstone.mathuto.databinding.ActivityQuizResultSummary7Binding
...
class QuizResultSummaryActivity7 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResultSummary7Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizResultSummary7Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = bundle!!.getIntegerArrayList(QuestionSeven.SELECTED_ANSWERS)
