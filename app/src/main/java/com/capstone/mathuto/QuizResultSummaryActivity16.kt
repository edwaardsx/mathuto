...
import com.capstone.mathuto.databinding.ActivityQuizResultSummary16Binding
...
class QuizResultSummaryActivity16 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResultSummary16Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizResultSummary16Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = bundle!!.getIntegerArrayList(QuestionSixteen.SELECTED_ANSWERS)
