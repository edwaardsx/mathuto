...
import com.capstone.mathuto.databinding.ActivityQuizResultSummary12Binding
...
class QuizResultSummaryActivity12 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResultSummary12Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizResultSummary12Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = bundle!!.getIntegerArrayList(QuestionTwelve.SELECTED_ANSWERS)
