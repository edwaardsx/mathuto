...
object QuestionTwelve {
    ...
    fun getQuestions(): ArrayList<QuestionMultipleChoice>{
        ...
        val que3 = QuestionMultipleChoice(
            1,
            "3. What process/es will you use to solve?",
            "Subtraction and Multiplication",
            "How much did Andrei share to  Hanna so that she could buy the books and bookmarks?",
        ...
        val que4 = QuestionMultipleChoice(
            1,
            "4. Translate it into a number sentence.",
            "Subtraction and Multiplication",
            "How much did Andrei share to  Hanna so that she could buy the books and bookmarks?",
        ...
        val que6 = QuestionMultipleChoice(
            1,
            "6. The cost of a toy car is $12.50. If Sarah buys two toy cars and a toy train for $27.75 in total, how much does the toy train cost?",
            "$2.75",
            "$3.75",
            "$4.75",
            "$5.75",
        ...
        val que7 = QuestionMultipleChoice(
            1,
            "7. A recipe calls for 1.5 cups of flour and 0.75 cups of sugar. If Tom wants to double the recipe, how many cups of flour and sugar does he need in total?",
        ...
        val que8 = QuestionMultipleChoice(
            1,
            "8. A restaurant sold 85 hamburgers on Monday and 92 hamburgers on Tuesday. If each hamburger costs $4.50, how much money did the restaurant make from hamburger sales on those two days?",
            "$756.00",
            "$804.50",
            "$814.50",
            "$842.50",
        ...
        val que9 = QuestionMultipleChoice(
            1,
            "9. Emma has $35.50. She spends $9.75 on a movie ticket and then buys a book. If the book costs $12.25, how much money does Emma have left?",
            "$11.25",
            "$13.50",
            "$13.75",
            "$15.00",
        ...
        val que10 = QuestionMultipleChoice(
            ...
            "10. Samantha has a rectangular garden that is 6.5 meters long and 4.25 meters wide. If she wants to add a pathway around the garden that is 1.75 meters wide, what will be the total area of the garden and the pathway?",
            "40.75 square meters",
            "47.50 square meters",
            "50.75 square meters",
            "55.25 square meters",
