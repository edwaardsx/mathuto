...
import com.capstone.mathuto.databinding.ActivityQuizResultSummary6Binding
...
class QuizResultSummaryActivity6 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResultSummary6Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizResultSummary6Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = bundle!!.getIntegerArrayList(QuestionSix.SELECTED_ANSWERS)
