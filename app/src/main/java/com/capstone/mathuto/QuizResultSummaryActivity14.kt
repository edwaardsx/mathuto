...
import com.capstone.mathuto.databinding.ActivityQuizResultSummary14Binding
...
class QuizResultSummaryActivity14 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResultSummary14Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizResultSummary14Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = bundle!!.getIntegerArrayList(QuestionFourteen.SELECTED_ANSWERS)
