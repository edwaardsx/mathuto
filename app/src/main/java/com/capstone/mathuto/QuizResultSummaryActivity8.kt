...
import com.capstone.mathuto.databinding.ActivityQuizResultSummary8Binding
...
class QuizResultSummaryActivity8 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResultSummary8Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizResultSummary8Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = bundle!!.getIntegerArrayList(QuestionEight.SELECTED_ANSWERS)
