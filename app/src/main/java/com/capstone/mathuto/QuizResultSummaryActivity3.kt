...
import com.capstone.mathuto.databinding.ActivityQuizResultSummary3Binding
...
class QuizResultSummaryActivity3 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResultSummary3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizResultSummary3Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = bundle!!.getIntegerArrayList(QuestionThree.SELECTED_ANSWERS)
