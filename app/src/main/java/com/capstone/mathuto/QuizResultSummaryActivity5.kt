...
import com.capstone.mathuto.databinding.ActivityQuizResultSummary5Binding
...
class QuizResultSummaryActivity5 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResultSummary5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizResultSummary5Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = bundle!!.getIntegerArrayList(QuestionFive.SELECTED_ANSWERS)
