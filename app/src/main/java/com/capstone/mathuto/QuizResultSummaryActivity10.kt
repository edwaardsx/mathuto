...
import com.capstone.mathuto.databinding.ActivityQuizResultSummary10Binding
...
class QuizResultSummaryActivity10 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResultSummary10Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizResultSummary10Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = bundle!!.getIntegerArrayList(QuestionTen.SELECTED_ANSWERS)
