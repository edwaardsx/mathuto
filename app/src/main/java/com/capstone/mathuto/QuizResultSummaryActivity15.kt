...
import com.capstone.mathuto.databinding.ActivityQuizResultSummary15Binding
...
class QuizResultSummaryActivity15 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResultSummary15Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizResultSummary15Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = bundle!!.getIntegerArrayList(QuestionFifteen.SELECTED_ANSWERS)
