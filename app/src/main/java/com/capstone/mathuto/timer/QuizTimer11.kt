...
import com.capstone.mathuto.databinding.ActivityQuizTimerElevenBinding
import com.capstone.mathuto.quiz.QuizOne
import com.capstone.mathuto.databinding.ActivityQuizTimerOneBinding
import com.capstone.mathuto.quiz.QuizEleven
import kotlin.random.Random

class QuizTimer11 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizTimerElevenBinding
    private lateinit var timer: CountDownTimer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizTimerElevenBinding.inflate(layoutInflater)
        ...
        timer = object : CountDownTimer(3_000,1000){
            ...
            override fun onFinish() {
                binding.textTimer.text = "Start!"
                    Handler().postDelayed({
                        val intent = Intent(applicationContext, QuizEleven::class.java)
