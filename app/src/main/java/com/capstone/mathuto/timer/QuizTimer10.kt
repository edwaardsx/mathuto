...
import com.capstone.mathuto.databinding.ActivityQuizTimerTenBinding
import com.capstone.mathuto.quiz.QuizTen
import kotlin.random.Random

class QuizTimer10 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizTimerTenBinding
    private lateinit var timer: CountDownTimer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizTimerTenBinding.inflate(layoutInflater)
        ...
        timer = object : CountDownTimer(3_000,1000){
            ...
            override fun onFinish() {
                binding.textTimer.text = "Start!"
                    Handler().postDelayed({
                        val intent = Intent(applicationContext, QuizTen::class.java)
