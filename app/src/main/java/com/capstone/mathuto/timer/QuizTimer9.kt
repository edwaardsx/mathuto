...
import com.capstone.mathuto.databinding.ActivityQuizTimerNineBinding
...
import com.capstone.mathuto.quiz.QuizNine
import kotlin.random.Random

class QuizTimer9 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizTimerNineBinding
    private lateinit var timer: CountDownTimer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizTimerNineBinding.inflate(layoutInflater)
        ...
        timer = object : CountDownTimer(3_000,1000){
            ...
            override fun onFinish() {
                binding.textTimer.text = "Start!"
                    Handler().postDelayed({
                        val intent = Intent(applicationContext, QuizNine::class.java)
