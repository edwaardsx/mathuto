...
import com.capstone.mathuto.databinding.ActivityQuizTimerFourteenBinding
import com.capstone.mathuto.quiz.QuizOne
import com.capstone.mathuto.databinding.ActivityQuizTimerOneBinding
import com.capstone.mathuto.quiz.QuizFourteen
import kotlin.random.Random

class QuizTimer14 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizTimerFourteenBinding
    private lateinit var timer: CountDownTimer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizTimerFourteenBinding.inflate(layoutInflater)
        ...
        timer = object : CountDownTimer(3_000,1000){
            ...
            override fun onFinish() {
                binding.textTimer.text = "Start!"
                    Handler().postDelayed({
                        val intent = Intent(applicationContext, QuizFourteen::class.java)
