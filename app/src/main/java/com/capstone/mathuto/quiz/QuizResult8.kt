...
import com.capstone.mathuto.QuizResultSummaryActivity8
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizResult8Binding
import com.capstone.mathuto.lessons.Lesson1
import com.capstone.mathuto.lessons.Lesson8
...
class QuizResult8 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResult8Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizResult8Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson8::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  QuizResultSummaryActivity8::class.java)
    ...
    private fun unLockNextLesson9() {
        ...
        dialog.setContentView(R.layout.activity_unlock_9)
