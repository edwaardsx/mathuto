...
import com.capstone.mathuto.questions.QuestionTwo.SELECTED_ANSWERS
import com.capstone.mathuto.questions.QuestionTwo.TOTAL_QUESTIONS
import com.capstone.mathuto.questions.QuestionTwo.UNANSWERED_QUESTIONS
...
class QuizTwo : AppCompatActivity(), View.OnClickListener {
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mQuestionList!!.size) {
            handler.postDelayed({
                val intent = Intent(applicationContext, QuizResult2::class.java)
                ...
                if (scores.isEmpty()) {
                    ...
                    val previousScore = Integer.parseInt(scores[1].score)
