...
import com.capstone.mathuto.databinding.ActivityQuizSixBinding
import com.capstone.mathuto.questions.QuestionOne.WRONG_ANS
import com.capstone.mathuto.questions.QuestionSix
import com.capstone.mathuto.questions.QuestionSix.CORRECT_ANS
import com.capstone.mathuto.questions.QuestionSix.SELECTED_ANSWERS
import com.capstone.mathuto.questions.QuestionSix.TOTAL_QUESTIONS
import com.capstone.mathuto.questions.QuestionSix.UNANSWERED_QUESTIONS
import com.capstone.mathuto.sqlite.SQLiteHelper

class QuizSix : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionList = QuestionSix.getQuestions()
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mQuestionList!!.size) {
            handler.postDelayed({
                val intent = Intent(applicationContext, QuizResult6::class.java)
