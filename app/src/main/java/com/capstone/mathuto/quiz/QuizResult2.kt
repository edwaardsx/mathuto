...
import com.capstone.mathuto.Main.Companion.QUIZ2_PASSED
...
import com.capstone.mathuto.QuizResultSummaryActivity2
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizResult2Binding
import com.capstone.mathuto.lessons.Lesson1
import com.capstone.mathuto.lessons.Lesson2
...
class QuizResult2 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResult2Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizResult2Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson2::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  QuizResultSummaryActivity2::class.java)
    ...
    private fun unLockNextLesson3() {
        ...
        dialog.setContentView(R.layout.activity_unlock_3)
