...
import com.capstone.mathuto.questions.QuestionThree
import com.capstone.mathuto.questions.QuestionTwelve
import com.capstone.mathuto.questions.QuestionTwelve.CORRECT_ANS
import com.capstone.mathuto.questions.QuestionTwelve.TOTAL_QUESTIONS
import com.capstone.mathuto.sqlite.Question
import com.capstone.mathuto.sqlite.SQLiteHelper

class QuizTwelve : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: ActivityQuizTwelveBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizTwelveBinding.inflate(layoutInflater)
        ...
        mQuestionList = QuestionTwelve.getQuestions()
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mQuestionList!!.size) {
            handler.postDelayed({
                ...
                intent.putExtra(QuestionThree.UNANSWERED_QUESTIONS, mQuestionList!!.size - (mCorrectAnswers + mWrongAnswers))
                intent.putExtra(QuestionThree.CORRECT_ANS, mCorrectAnswers)
                intent.putIntegerArrayListExtra(QuestionThree.SELECTED_ANSWERS, selectedAnswer)
