...
import com.capstone.mathuto.Main.Companion.QUIZ10_PASSED
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizTenBinding
import com.capstone.mathuto.questions.QuestionOne.WRONG_ANS
import com.capstone.mathuto.questions.QuestionTen
import com.capstone.mathuto.questions.QuestionTen.CORRECT_ANS
import com.capstone.mathuto.questions.QuestionTen.SELECTED_ANSWERS
import com.capstone.mathuto.questions.QuestionTen.TOTAL_QUESTIONS
import com.capstone.mathuto.questions.QuestionTen.UNANSWERED_QUESTIONS
import com.capstone.mathuto.sqlite.Question
import com.capstone.mathuto.sqlite.SQLiteHelper

class QuizTen : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionList = QuestionTen.getQuestions()
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mQuestionList!!.size) {
            handler.postDelayed({
                val intent = Intent(applicationContext, QuizResult10::class.java)
