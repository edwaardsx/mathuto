...
import com.capstone.mathuto.QuizResultSummaryActivity14
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizResult14Binding
import com.capstone.mathuto.lessons.Lesson1
import com.capstone.mathuto.lessons.Lesson14
...
class QuizResult14 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResult14Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizResult14Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson14::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  QuizResultSummaryActivity14::class.java)
    ...
    private fun unLockNextLesson15() {
        ...
        dialog.setContentView(R.layout.activity_unlock_15)
