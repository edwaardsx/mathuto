...
class QuizResult1 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResult1Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizResult1Binding.inflate(layoutInflater)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  QuizResultSummaryActivity1::class.java)
