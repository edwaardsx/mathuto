...
import com.capstone.mathuto.QuizResultSummaryActivity9
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizResult9Binding
import com.capstone.mathuto.lessons.Lesson1
import com.capstone.mathuto.lessons.Lesson9
...
class QuizResult9 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResult9Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizResult9Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson9::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  QuizResultSummaryActivity9::class.java)
    ...
    private fun unLockNextLesson10() {
        ...
        dialog.setContentView(R.layout.activity_unlock_10)
