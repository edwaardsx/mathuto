...
import com.capstone.mathuto.Main.Companion.QUIZ11_PASSED
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizElevenBinding
import com.capstone.mathuto.questions.QuestionEleven
import com.capstone.mathuto.questions.QuestionEleven.CORRECT_ANS
import com.capstone.mathuto.questions.QuestionEleven.SELECTED_ANSWERS
import com.capstone.mathuto.questions.QuestionEleven.TOTAL_QUESTIONS
import com.capstone.mathuto.questions.QuestionEleven.UNANSWERED_QUESTIONS
import com.capstone.mathuto.questions.QuestionOne.WRONG_ANS
import com.capstone.mathuto.sqlite.SQLiteHelper

class QuizEleven : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: ActivityQuizElevenBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizElevenBinding.inflate(layoutInflater)
        ...
        mQuestionList = QuestionEleven.getQuestions()
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mQuestionList!!.size) {
            handler.postDelayed({
                val intent = Intent(applicationContext, QuizResult11::class.java)
                ...
                } else if (scores.size >= 11) {
                    val previousScore = Integer.parseInt(scores[10].score)
