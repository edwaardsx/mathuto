...
import com.capstone.mathuto.questions.QuestionNineteen.SELECTED_ANSWERS
import com.capstone.mathuto.questions.QuestionNineteen.TOTAL_QUESTIONS
import com.capstone.mathuto.questions.QuestionNineteen.UNANSWERED_QUESTIONS
...
class QuizNineteen : AppCompatActivity(), View.OnClickListener {
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mQuestionList!!.size) {
            handler.postDelayed({
                val intent = Intent(applicationContext, QuizResult19::class.java)
                ...
                } else if (scores.size >= 19) {
                    val previousScore = Integer.parseInt(scores[18].score)
