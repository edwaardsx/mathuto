...
import com.capstone.mathuto.Main.Companion.QUIZ15_PASSED
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizFifteenBinding
import com.capstone.mathuto.questions.QuestionFifteen
import com.capstone.mathuto.questions.QuestionFifteen.CORRECT_ANS
import com.capstone.mathuto.questions.QuestionFifteen.SELECTED_ANSWERS
import com.capstone.mathuto.questions.QuestionFifteen.TOTAL_QUESTIONS
import com.capstone.mathuto.questions.QuestionFifteen.UNANSWERED_QUESTIONS
...
class QuizFifteen : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: ActivityQuizFifteenBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizFifteenBinding.inflate(layoutInflater)
        ...
        mQuestionList = QuestionFifteen.getQuestions()
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mQuestionList!!.size) {
            handler.postDelayed({
                val intent = Intent(applicationContext, QuizResult15::class.java)
                ...
                } else if (scores.size >= 15) {
                    val previousScore = Integer.parseInt(scores[14].score)
