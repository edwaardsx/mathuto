...
import com.capstone.mathuto.Main.Companion.QUIZ5_PASSED
...
import com.capstone.mathuto.QuizResultSummaryActivity5
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizResult5Binding
import com.capstone.mathuto.lessons.Lesson1
import com.capstone.mathuto.lessons.Lesson5
...
class QuizResult5 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResult5Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizResult5Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson5::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  QuizResultSummaryActivity5::class.java)
    ...
    private fun unLockNextLesson6() {
        val dialog = Dialog(this)
        dialog.setContentView(R.layout.activity_unlock_6)
