...
import com.capstone.mathuto.Main.Companion.QUIZ19_PASSED
import com.capstone.mathuto.Main.Companion.QUIZ1_PASSED
import com.capstone.mathuto.Main.Companion.WATCHED_TUTORIAL1
import com.capstone.mathuto.Main.Companion.WATCHED_TUTORIAL19
import com.capstone.mathuto.QuizResultSummaryActivity1
import com.capstone.mathuto.QuizResultSummaryActivity19
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizResult19Binding
import com.capstone.mathuto.lessons.Lesson1
import com.capstone.mathuto.lessons.Lesson19
...
class QuizResult19 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResult19Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizResult19Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson19::class.java)
            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK
            applicationContext.startActivity(intent)
            overridePendingTransition(0, 0)
        }
        binding.btnMainMenu.setOnClickListener {
            if(QUIZ19_PASSED && WATCHED_TUTORIAL19)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  QuizResultSummaryActivity19::class.java)
    ...
    private fun completeCongratulations() {
        val dialog = Dialog(this)
        dialog.setContentView(R.layout.activity_congratulations)
