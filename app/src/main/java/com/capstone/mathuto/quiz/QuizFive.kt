...
import com.capstone.mathuto.questions.QuestionFive.CORRECT_ANS
import com.capstone.mathuto.questions.QuestionFive.SELECTED_ANSWERS
import com.capstone.mathuto.questions.QuestionFive.TOTAL_QUESTIONS
import com.capstone.mathuto.questions.QuestionFive.UNANSWERED_QUESTIONS
import com.capstone.mathuto.questions.QuestionOne.WRONG_ANS
import com.capstone.mathuto.sqlite.SQLiteHelper

class QuizFive : AppCompatActivity(), View.OnClickListener {
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mQuestionList!!.size) {
            handler.postDelayed({
                val intent = Intent(applicationContext, QuizResult5::class.java)
