...
import com.capstone.mathuto.QuizResultSummaryActivity18
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizResult18Binding
import com.capstone.mathuto.lessons.Lesson1
import com.capstone.mathuto.lessons.Lesson18
...
class QuizResult18 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResult18Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizResult18Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson18::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  QuizResultSummaryActivity18::class.java)
    ...
    private fun unLockNextLesson19() {
        ...
        dialog.setContentView(R.layout.activity_unlock_19)
