...
import com.capstone.mathuto.QuizResultSummaryActivity12
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizResult12Binding
import com.capstone.mathuto.lessons.Lesson1
import com.capstone.mathuto.lessons.Lesson12
...
class QuizResult12 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResult12Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizResult12Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson12::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  QuizResultSummaryActivity12::class.java)
    ...
    private fun unLockNextLesson13() {
        ...
        dialog.setContentView(R.layout.activity_unlock_13)
