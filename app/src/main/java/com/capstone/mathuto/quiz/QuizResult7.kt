...
import com.capstone.mathuto.Main.Companion.QUIZ7_PASSED
...
import com.capstone.mathuto.QuizResultSummaryActivity7
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizResult7Binding
import com.capstone.mathuto.lessons.Lesson1
import com.capstone.mathuto.lessons.Lesson7
...
class QuizResult7 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResult7Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizResult7Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson7::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  QuizResultSummaryActivity7::class.java)
    ...
    private fun unLockNextLesson8() {
        ...
        dialog.setContentView(R.layout.activity_unlock_8)
