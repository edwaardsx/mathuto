...
import com.capstone.mathuto.QuizResultSummaryActivity17
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizResult17Binding
import com.capstone.mathuto.lessons.Lesson1
import com.capstone.mathuto.lessons.Lesson17
...
class QuizResult17 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResult17Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizResult17Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson17::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  QuizResultSummaryActivity17::class.java)
    ...
    private fun unLockNextLesson18() {
        ...
        dialog.setContentView(R.layout.activity_unlock_18)
