...
import com.capstone.mathuto.Main.Companion.QUIZ6_PASSED
import com.capstone.mathuto.Main.Companion.WATCHED_TUTORIAL1
import com.capstone.mathuto.Main.Companion.WATCHED_TUTORIAL6
import com.capstone.mathuto.QuizResultSummaryActivity1
import com.capstone.mathuto.QuizResultSummaryActivity6
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizResult6Binding
import com.capstone.mathuto.lessons.Lesson1
import com.capstone.mathuto.lessons.Lesson6
...
class QuizResult6 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResult6Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizResult6Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson6::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  QuizResultSummaryActivity6::class.java)
    ...
    private fun unLockNextLesson7() {
        ...
        dialog.setContentView(R.layout.activity_unlock_7)
