...
import com.capstone.mathuto.QuizResultSummaryActivity11
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizResult11Binding
import com.capstone.mathuto.lessons.Lesson1
import com.capstone.mathuto.lessons.Lesson11
...
class QuizResult11 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResult11Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizResult11Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson11::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  QuizResultSummaryActivity11::class.java)
    ...
    private fun unLockNextLesson12() {
        ...
        dialog.setContentView(R.layout.activity_unlock_12)
