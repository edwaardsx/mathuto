...
import com.capstone.mathuto.Main.Companion.WATCHED_TUTORIAL15
import com.capstone.mathuto.QuizResultSummaryActivity1
import com.capstone.mathuto.QuizResultSummaryActivity15
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizResult15Binding
import com.capstone.mathuto.lessons.Lesson1
import com.capstone.mathuto.lessons.Lesson15
...
class QuizResult15 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResult15Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizResult15Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson15::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  QuizResultSummaryActivity15::class.java)
    ...
    private fun unLockNextLesson16() {
        ...
        dialog.setContentView(R.layout.activity_unlock_16)
