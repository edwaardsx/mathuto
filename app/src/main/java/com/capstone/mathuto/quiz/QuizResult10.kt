...
import com.capstone.mathuto.QuizResultSummaryActivity10
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizResult10Binding
import com.capstone.mathuto.lessons.Lesson1
import com.capstone.mathuto.lessons.Lesson10
...
class QuizResult10 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResult10Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizResult10Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson10::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  QuizResultSummaryActivity10::class.java)
    ...
    private fun unLockNextLesson11() {
        ...
        dialog.setContentView(R.layout.activity_unlock_11)
