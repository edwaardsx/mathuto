...
import com.capstone.mathuto.Main.Companion.QUIZ17_PASSED
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizSeventeenBinding
import com.capstone.mathuto.questions.QuestionOne.WRONG_ANS
import com.capstone.mathuto.questions.QuestionSeventeen
import com.capstone.mathuto.questions.QuestionSeventeen.CORRECT_ANS
import com.capstone.mathuto.questions.QuestionSeventeen.SELECTED_ANSWERS
import com.capstone.mathuto.questions.QuestionSeventeen.TOTAL_QUESTIONS
import com.capstone.mathuto.questions.QuestionSeventeen.UNANSWERED_QUESTIONS
import com.capstone.mathuto.sqlite.Question
import com.capstone.mathuto.sqlite.SQLiteHelper

class QuizSeventeen : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: ActivityQuizSeventeenBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizSeventeenBinding.inflate(layoutInflater)
        ...
        mQuestionList = QuestionSeventeen.getQuestions()
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mQuestionList!!.size) {
            handler.postDelayed({
                val intent = Intent(applicationContext, QuizResult17::class.java)
                ...
                } else if (scores.size >= 17) {
                    val previousScore = Integer.parseInt(scores[16].score)
