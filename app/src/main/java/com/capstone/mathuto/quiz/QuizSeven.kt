...
import com.capstone.mathuto.databinding.ActivityQuizSevenBinding
...
import com.capstone.mathuto.questions.QuestionSeven.SELECTED_ANSWERS
import com.capstone.mathuto.questions.QuestionSeven.TOTAL_QUESTIONS
import com.capstone.mathuto.questions.QuestionSeven.UNANSWERED_QUESTIONS
...
class QuizSeven : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionList = QuestionSeven.getQuestions()
        setQuestion()
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mQuestionList!!.size) {
            handler.postDelayed({
                val intent = Intent(applicationContext, QuizResult7::class.java)
                ...
                if(scores.isEmpty()){
                    ...
                    val previousScore = Integer.parseInt(scores[6].score)
