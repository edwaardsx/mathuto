...
import com.capstone.mathuto.Main.Companion.QUIZ18_PASSED
import com.capstone.mathuto.R
import com.capstone.mathuto.databinding.ActivityQuizEighteenBinding
import com.capstone.mathuto.questions.QuestionEighteen
import com.capstone.mathuto.questions.QuestionEighteen.CORRECT_ANS
import com.capstone.mathuto.questions.QuestionEighteen.SELECTED_ANSWERS
import com.capstone.mathuto.questions.QuestionEighteen.TOTAL_QUESTIONS
import com.capstone.mathuto.questions.QuestionEighteen.UNANSWERED_QUESTIONS
...
class QuizEighteen : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: ActivityQuizEighteenBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizEighteenBinding.inflate(layoutInflater)
        ...
        mQuestionList = QuestionEighteen.getQuestions()
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mQuestionList!!.size) {
            handler.postDelayed({
                val intent = Intent(applicationContext, QuizResult18::class.java)
