...
import com.capstone.mathuto.databinding.ActivityQuizSixteenBinding
import com.capstone.mathuto.questions.QuestionOne.WRONG_ANS
import com.capstone.mathuto.questions.QuestionSixteen
import com.capstone.mathuto.questions.QuestionSixteen.CORRECT_ANS
import com.capstone.mathuto.questions.QuestionSixteen.SELECTED_ANSWERS
import com.capstone.mathuto.questions.QuestionSixteen.TOTAL_QUESTIONS
import com.capstone.mathuto.questions.QuestionSixteen.UNANSWERED_QUESTIONS
import com.capstone.mathuto.sqlite.Question
import com.capstone.mathuto.sqlite.SQLiteHelper

class QuizSixteen : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: ActivityQuizSixteenBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizSixteenBinding.inflate(layoutInflater)
        ...
        mQuestionList = QuestionSixteen.getQuestions()
    ...
    private fun processOptionSelected() {
        ...
        if (mCurrentPosition == mQuestionList!!.size) {
            handler.postDelayed({
                val intent = Intent(applicationContext, QuizResult16::class.java)
                ...
                } else if (scores.size >= 16) {
                    val previousScore = Integer.parseInt(scores[15].score)
