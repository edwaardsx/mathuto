...
class QuizResult3 : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityQuizResult3Binding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityQuizResult3Binding.inflate(layoutInflater)
        ...
        binding.btnBack.setOnClickListener{
            val intent = Intent(applicationContext,  Lesson3::class.java)
        ...
        binding.btnSummary.setOnClickListener{
            ...
            val intent = Intent(applicationContext,  QuizResultSummaryActivity3::class.java)
    ...
    private fun unLockNextLesson4() {
        ...
        dialog.setContentView(R.layout.activity_unlock_4)
