...
import com.capstone.mathuto.databinding.ActivityQuizResultSummary13Binding
...
class QuizResultSummaryActivity13 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResultSummary13Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizResultSummary13Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = bundle!!.getIntegerArrayList(QuestionThirteen.SELECTED_ANSWERS)
