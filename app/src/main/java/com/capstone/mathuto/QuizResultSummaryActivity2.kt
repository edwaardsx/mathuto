...
import com.capstone.mathuto.databinding.ActivityQuizResultSummary2Binding
...
class QuizResultSummaryActivity2 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizResultSummary2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizResultSummary2Binding.inflate(layoutInflater)
    ...
    private fun setQuestion() {
        ...
        val myIntArray = bundle!!.getIntegerArrayList(QuestionTwo.SELECTED_ANSWERS)
